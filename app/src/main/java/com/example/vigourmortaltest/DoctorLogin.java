            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(passwordFromDB.equals(userEnteredPassword)){
                        ...
                        String departFromDB = dataSnapshot.child(userEnteredPhone).child("depart").getValue(String.class);
                        ...
                        Intent intent = new Intent(getApplicationContext(),DoctorHomeScreen.class);

                        intent.putExtra("name",nameFromDB);
                        intent.putExtra("email",emaiFromDB);
                        intent.putExtra("blood",departFromDB);
